                            ...
                            <div class="card-body">
                                <div class="form-row">
                                    <div class="form-group col">
                                        <label for="first_name">{{ __('Nombres ') }}</label> <span class="text-danger">*</span>
                                    ...
                                    <div class="form-group col">
                                        <label for="last_name">{{ __('Apellidos') }}</label> <span class="text-danger">*</span>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col">
                                        <label>{{ __('Celular') }}</label> <span class="text-danger">*</span>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col">
                                        <label>{{ __('Nombre de Cooperativa') }}</label>
